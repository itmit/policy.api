                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail или') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Дата рождения') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="field_of_activity" class="col-md-4 col-form-label text-md-right">{{ __('Сфера деятельности') }}</label>

                            <div class="col-md-6">
                                <input id="field_of_activity" type="text" class="form-control @error('field_of_activity') is-invalid @enderror" name="field_of_activity" value="{{ old('field_of_activity') }}" required autocomplete="field_of_activity">
                        ...
                        <div class="form-group row">
                            <label for="position" class="col-md-4 col-form-label text-md-right">{{ __('Должность') }}</label>
