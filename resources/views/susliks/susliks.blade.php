    ...
    $(document).on('change', '.suslik-by-category', function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                result += '<tr name="l-m"><td colspan="9" style="text-align: center; cursor: pointer" name="load-more" data-c="50">загрузить еще</td></tr>';
                $('tbody').html(result);
    ...
    $(document).on('click', '.suslik-sort', function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                result += '<tr name="l-m"><td colspan="9" style="text-align: center; cursor: pointer" name="load-more" data-c="'+c+'">загрузить еще</td></tr>';
                $('tbody').html(result);
    ...
    $(document).on('click', 'td[name="load-more"]', function() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                result += '<tr name="l-m"><td colspan="9" style="text-align: center; cursor: pointer" name="load-more" data-c="'+newC+'">загрузить еще</td></tr>';
                $('tr[name="l-m"]').remove();
                $('tbody').append(result);
                $('.loader').css('display', 'none');
            },
